...
<pre class="prettyprint prettyprinted" style=""><code><span class="pln">C</span><span class="pun">:</span><span class="pln">\Documents </span><span class="kwd">and</span><span class="pln"> </span><span class="typ">Settings</span><span class="pln">\Administrator</span><span class="pun">&gt;</span><span class="pln">gradle
...
<pre class="prettyprint prettyprinted" style=""><code><span class="pun">最后看一下你的文件目录结构：</span><span class="com">//（这是一个由 Eclipse IDE 创建的项目）</span><span class="pln">
...
<pre class="prettyprint prettyprinted" style=""><code><span class="pln">apply plugin</span><span class="pun">:</span><span class="pln"> </span><span class="str">'java'</span><span class="pln">   
...
<pre class="prettyprint prettyprinted" style=""><code><span class="com">// 下面这个配置包含3个模块：</span><span class="pln">
...
<pre class="prettyprint prettyprinted" style=""><code><span class="pln">F</span><span class="pun">:</span><span class="pln">\workspace\Hello</span><span class="pun">&gt;</span><span class="pln">gradle build
...
<pre class="prettyprint prettyprinted" style=""><code><span class="pln">    </span><span class="com">/**
...
<pre class="prettyprint prettyprinted" style=""><code><span class="pln">    defaultConfig </span><span class="pun">{</span><span class="pln">
